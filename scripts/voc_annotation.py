...
def convert_voc_annotation(data_path, data_type, anno_path, use_difficult_bbox=False):
    ...
    #            'train', 'tvmonitor']
    # 对于Exp_Dark:Bicycle, Boat, Bottle, Bus, Car, Cat, Chair, Dog, Motorbike, Person
    ...
    with open(anno_path, 'a') as f:
        for image_ind in image_inds:
            ...
            # 找到Object的标签，取得该Object是否是困难样本，如果是难样本就跳过
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="/project/data/VOC/")
