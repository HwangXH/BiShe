...
parser.add_argument('--exp_num', dest='exp_num', type=str, default='57', help='current experiment number')
...
parser.add_argument('--WRITE_IMAGE_PATH', dest='WRITE_IMAGE_PATH', nargs='*', default='./experiments_lowlight/exp_57/detection_results_exdark02/', help='folder of the training data')
parser.add_argument('--WEIGHT_FILE', dest='WEIGHT_FILE', nargs='*', default='./experiments_lowlight/exp_57/checkpoint/yolov3_test_loss=10.0633.ckpt-66', help='folder of the training data')
