...
parser.add_argument('--exp_num', dest='exp_num', type=str, default='107', help='current experiment number')
...
parser.add_argument('--vocfog_traindata_dir', dest='vocfog_traindata_dir', default='/project/data/data_vocfog/train/JPEGImage/',
                    help='the dir contains ten levels synthetic foggy images')
parser.add_argument('--vocfog_valdata_dir', dest='vocfog_valdata_dir', default='/project/data/data_vocfog/val/JPEGImage/',
                    help='the dir contains ten levels synthetic foggy images')
...
parser.add_argument('--WRITE_IMAGE_PATH', dest='WRITE_IMAGE_PATH', nargs='*', default='./experiments/exp_107/detection_results_show/', help='folder of the training data')
