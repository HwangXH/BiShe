...
#'/data/vdd/liuwenyu/data_vocfog/train/JPEGImages/'
    ...
    for i in range(10):
        ...
        img_name = '/project/data/data_vocfog/train/JPEGImage/' + image_name \
                   + '_' + ("%.2f" % beta) + '.' + image_name_index
        # img_name = '/project/data/data_vocfog/val/JPEGImage/' + image_name \
        #    + '_' + ("%.2f"%beta) + '.' + image_name_index
...
if __name__ == '__main__':
    an = load_annotations('/project/Image-Adaptive-YOLO/data/dataset_fog/voc_norm_train.txt')
    # an = load_annotations('/project/Image-Adaptive-YOLO/data/dataset_fog/voc_norm_test.txt')
